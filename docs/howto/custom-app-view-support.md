...
In addition to our [custom form component support](https://github.com/kubeapps/kubeapps/blob/main/docs/howto/custom-form-component-support.md) we now support the ability for developers to inject custom app views for specific deployments.
