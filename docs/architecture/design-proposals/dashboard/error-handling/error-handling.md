...
* Stage 1: Implement error boundary for unexpected runtime rendering errors, reusing the `UnexpectedError` component. https://github.com/kubeapps/kubeapps/issues/724
* Stage 2: Implement an instance of ErrorSelector in the layout connected to the redux store, move a couple of ErrorSelector consumers to this new model https://github.com/kubeapps/kubeapps/issues/725
* Stage 3: Finish the migration of all these consumers from rendering the component to dispatch an error and remove those renders https://github.com/kubeapps/kubeapps/issues/725
* Stage 4: Change the errorBoundary component to rely on the connected errorSelector implemented in stage 2 and remove its own render https://github.com/kubeapps/kubeapps/issues/726
* Stage 5: Look into merging errorBoundary and errorSelector https://github.com/kubeapps/kubeapps/issues/727
