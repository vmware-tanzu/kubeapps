...
var file_ocicatalog_v1alpha1_ocicatalog_proto_goTypes = []interface{}{
...
func file_ocicatalog_v1alpha1_ocicatalog_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_ocicatalog_v1alpha1_ocicatalog_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ocicatalog_v1alpha1_ocicatalog_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ocicatalog_v1alpha1_ocicatalog_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ocicatalog_v1alpha1_ocicatalog_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Tag); i {
			case 0:
				return &v.state
			case 1:
