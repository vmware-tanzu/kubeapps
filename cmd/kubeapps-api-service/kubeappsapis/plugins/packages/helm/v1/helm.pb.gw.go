...
import (
	...
	"github.com/kubeapps/kubeapps/cmd/kubeapps-api-service/kubeappsapis/core/packages/v1"
...
var (
	filter_PackagesService_GetInstalledPackages_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_PackagesService_GetInstalledPackages_0(ctx context.Context, marshaler runtime.Marshaler, client PackagesServiceClient, req *http.Request, pathParams map[string]string) (PackagesService_GetInstalledPackagesClient, runtime.ServerMetadata, error) {
	var protoReq v1.GetInstalledPackagesRequest
	var metadata runtime.ServerMetadata

	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_PackagesService_GetInstalledPackages_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	stream, err := client.GetInstalledPackages(ctx, &protoReq)
	if err != nil {
...
func RegisterPackagesServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PackagesServiceServer) error {
	...
	mux.Handle("GET", pattern_PackagesService_GetInstalledPackages_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterPackagesServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PackagesServiceClient) error {
	...
	mux.Handle("GET", pattern_PackagesService_GetInstalledPackages_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/kubeappsapis.plugins.packages.helm.v1.PackagesService/GetInstalledPackages")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_PackagesService_GetInstalledPackages_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_PackagesService_GetInstalledPackages_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_PackagesService_GetInstalledPackages_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"helm", "v1", "installed-packages"}, ""))
)

var (
	forward_PackagesService_GetInstalledPackages_0 = runtime.ForwardResponseStream
)
