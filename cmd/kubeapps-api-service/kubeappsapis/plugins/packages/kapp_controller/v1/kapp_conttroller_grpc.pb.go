...
func (c *packagesServiceClient) GetAvailablePackages(ctx context.Context, in *v1.GetAvailablePackagesRequest, opts ...grpc.CallOption) (PackagesService_GetAvailablePackagesClient, error) {
	stream, err := c.cc.NewStream(ctx, &PackagesService_ServiceDesc.Streams[0], "/kubeappsapis.plugins.packages.kapp_controller.v1.PackagesService/GetAvailablePackages", opts...)
	if err != nil {
		return nil, err
	}
...
var PackagesService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kubeappsapis.plugins.packages.kapp_controller.v1.PackagesService",
	...
	Metadata: "kubeappsapis/plugins/packages/kapp_controller/v1/kapp_conttroller.proto",
}
