...
func (c *packagesClient) GetAvailablePackages(ctx context.Context, in *v1.GetAvailablePackagesRequest, opts ...grpc.CallOption) (Packages_GetAvailablePackagesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Packages_ServiceDesc.Streams[0], "/kubeapps.api.packages.v1.kapp_controller.Packages/GetAvailablePackages", opts...)
	if err != nil {
		return nil, err
	}
...
var Packages_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kubeapps.api.packages.v1.kapp_controller.Packages",
