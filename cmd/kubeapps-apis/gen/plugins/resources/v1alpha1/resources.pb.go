...
var file_kubeappsapis_plugins_resources_v1alpha1_resources_proto_rawDesc = []byte{
	...
	0x74, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x32, 0x9f, 0x05, 0x0a, 0x10, 0x52, 0x65, 0x73, 0x6f, 0x75,
	...
	0x75, 0x6e, 0x74, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x42, 0x4f, 0x5a, 0x4d, 0x67, 0x69, 0x74, 0x68,
...
var file_kubeappsapis_plugins_resources_v1alpha1_resources_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_kubeappsapis_plugins_resources_v1alpha1_resources_proto_goTypes = []interface{}{
	...
	(*v1alpha1.InstalledPackageReference)(nil), // 4: kubeappsapis.core.packages.v1alpha1.InstalledPackageReference
	(*v1alpha1.ResourceRef)(nil),               // 5: kubeappsapis.core.packages.v1alpha1.ResourceRef
	(*anypb.Any)(nil),                          // 6: google.protobuf.Any
	(*v1alpha1.Context)(nil),                   // 7: kubeappsapis.core.packages.v1alpha1.Context
}
var file_kubeappsapis_plugins_resources_v1alpha1_resources_proto_depIdxs = []int32{
	4, // 0: kubeappsapis.plugins.resources.v1alpha1.GetResourcesRequest.installed_package_ref:type_name -> kubeappsapis.core.packages.v1alpha1.InstalledPackageReference
	5, // 1: kubeappsapis.plugins.resources.v1alpha1.GetResourcesRequest.resource_refs:type_name -> kubeappsapis.core.packages.v1alpha1.ResourceRef
	5, // 2: kubeappsapis.plugins.resources.v1alpha1.GetResourcesResponse.resource_ref:type_name -> kubeappsapis.core.packages.v1alpha1.ResourceRef
	6, // 3: kubeappsapis.plugins.resources.v1alpha1.GetResourcesResponse.manifest:type_name -> google.protobuf.Any
	7, // 4: kubeappsapis.plugins.resources.v1alpha1.GetServiceAccountNamesRequest.context:type_name -> kubeappsapis.core.packages.v1alpha1.Context
	0, // 5: kubeappsapis.plugins.resources.v1alpha1.ResourcesService.GetResources:input_type -> kubeappsapis.plugins.resources.v1alpha1.GetResourcesRequest
	2, // 6: kubeappsapis.plugins.resources.v1alpha1.ResourcesService.GetServiceAccountNames:input_type -> kubeappsapis.plugins.resources.v1alpha1.GetServiceAccountNamesRequest
	1, // 7: kubeappsapis.plugins.resources.v1alpha1.ResourcesService.GetResources:output_type -> kubeappsapis.plugins.resources.v1alpha1.GetResourcesResponse
	3, // 8: kubeappsapis.plugins.resources.v1alpha1.ResourcesService.GetServiceAccountNames:output_type -> kubeappsapis.plugins.resources.v1alpha1.GetServiceAccountNamesResponse
