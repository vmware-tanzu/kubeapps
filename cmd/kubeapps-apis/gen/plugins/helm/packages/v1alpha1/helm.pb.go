...
var file_kubeappsapis_plugins_helm_packages_v1alpha1_helm_proto_rawDesc = []byte{
	...
	0x65, 0x61, 0x73, 0x65, 0x52, 0x65, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x32, 0x9b, 0x0d, 0x0a,
	...
	0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x73, 0x3a, 0x01, 0x2a, 0x42, 0x53, 0x5a, 0x51, 0x67, 0x69,
...
var file_kubeappsapis_plugins_helm_packages_v1alpha1_helm_proto_goTypes = []interface{}{
	...
	(*v1alpha1.GetInstalledPackageSummariesResponse)(nil), // 11: kubeappsapis.core.packages.v1alpha1.GetInstalledPackageSummariesResponse
	(*v1alpha1.GetInstalledPackageDetailResponse)(nil),    // 12: kubeappsapis.core.packages.v1alpha1.GetInstalledPackageDetailResponse
	(*v1alpha1.CreateInstalledPackageResponse)(nil),       // 13: kubeappsapis.core.packages.v1alpha1.CreateInstalledPackageResponse
	(*v1alpha1.UpdateInstalledPackageResponse)(nil),       // 14: kubeappsapis.core.packages.v1alpha1.UpdateInstalledPackageResponse
}
var file_kubeappsapis_plugins_helm_packages_v1alpha1_helm_proto_depIdxs = []int32{
	...
	8,  // 7: kubeappsapis.plugins.helm.packages.v1alpha1.HelmPackagesService.GetAvailablePackageSummaries:output_type -> kubeappsapis.core.packages.v1alpha1.GetAvailablePackageSummariesResponse
	9,  // 8: kubeappsapis.plugins.helm.packages.v1alpha1.HelmPackagesService.GetAvailablePackageDetail:output_type -> kubeappsapis.core.packages.v1alpha1.GetAvailablePackageDetailResponse
	10, // 9: kubeappsapis.plugins.helm.packages.v1alpha1.HelmPackagesService.GetAvailablePackageVersions:output_type -> kubeappsapis.core.packages.v1alpha1.GetAvailablePackageVersionsResponse
	11, // 10: kubeappsapis.plugins.helm.packages.v1alpha1.HelmPackagesService.GetInstalledPackageSummaries:output_type -> kubeappsapis.core.packages.v1alpha1.GetInstalledPackageSummariesResponse
	12, // 11: kubeappsapis.plugins.helm.packages.v1alpha1.HelmPackagesService.GetInstalledPackageDetail:output_type -> kubeappsapis.core.packages.v1alpha1.GetInstalledPackageDetailResponse
	13, // 12: kubeappsapis.plugins.helm.packages.v1alpha1.HelmPackagesService.CreateInstalledPackage:output_type -> kubeappsapis.core.packages.v1alpha1.CreateInstalledPackageResponse
	14, // 13: kubeappsapis.plugins.helm.packages.v1alpha1.HelmPackagesService.UpdateInstalledPackage:output_type -> kubeappsapis.core.packages.v1alpha1.UpdateInstalledPackageResponse
