...
func file_kubeappsapis_core_plugins_v1alpha1_plugins_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_kubeappsapis_core_plugins_v1alpha1_plugins_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_kubeappsapis_core_plugins_v1alpha1_plugins_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_kubeappsapis_core_plugins_v1alpha1_plugins_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Plugin); i {
			case 0:
				return &v.state
			case 1:
