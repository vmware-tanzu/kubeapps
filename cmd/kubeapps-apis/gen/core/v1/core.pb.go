...
type RegisteredPluginsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *RegisteredPluginsRequest) Reset() {
	*x = RegisteredPluginsRequest{}
...
func (x *RegisteredPluginsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisteredPluginsRequest) ProtoMessage() {}

func (x *RegisteredPluginsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_kubeappsapis_core_v1_core_proto_msgTypes[0]
...
// Deprecated: Use RegisteredPluginsRequest.ProtoReflect.Descriptor instead.
func (*RegisteredPluginsRequest) Descriptor() ([]byte, []int) {
	return file_kubeappsapis_core_v1_core_proto_rawDescGZIP(), []int{0}
}

type RegisteredPluginsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RegisteredPluginsResponse) Reset() {
	*x = RegisteredPluginsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *RegisteredPluginsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisteredPluginsResponse) ProtoMessage() {}

func (x *RegisteredPluginsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_kubeappsapis_core_v1_core_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisteredPluginsResponse.ProtoReflect.Descriptor instead.
func (*RegisteredPluginsResponse) Descriptor() ([]byte, []int) {
	return file_kubeappsapis_core_v1_core_proto_rawDescGZIP(), []int{1}
}

func (x *RegisteredPluginsResponse) GetPlugins() []string {
	if x != nil {
		return x.Plugins
	}
	return nil
...
var file_kubeappsapis_core_v1_core_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x1a, 0x0a, 0x18, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65,
	0x72, 0x65, 0x64, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x22, 0x35, 0x0a, 0x19, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x65, 0x64, 0x50,
	...
	,
...
var file_kubeappsapis_core_v1_core_proto_goTypes = []interface{}{
	(*RegisteredPluginsRequest)(nil),  // 0: kubeappsapis.core.v1.RegisteredPluginsRequest
	(*RegisteredPluginsResponse)(nil), // 1: kubeappsapis.core.v1.RegisteredPluginsResponse
}
var file_kubeappsapis_core_v1_core_proto_depIdxs = []int32{
	0, // 0: kubeappsapis.core.v1.CoreService.RegisteredPlugins:input_type -> kubeappsapis.core.v1.RegisteredPluginsRequest
	1, // 1: kubeappsapis.core.v1.CoreService.RegisteredPlugins:output_type -> kubeappsapis.core.v1.RegisteredPluginsResponse
...
func file_kubeappsapis_core_v1_core_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_kubeappsapis_core_v1_core_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegisteredPluginsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_kubeappsapis_core_v1_core_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegisteredPluginsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
