...
func setupRoutes() http.Handler {
	...
	apiv1.Methods("GET").Path("/ns/{namespace}/charts/search").Queries("q", "{query}").Handler(WithParams(searchCharts))
	apiv1.Methods("GET").Path("/ns/{namespace}/charts/search").Queries("q", "{query}", "showDuplicates", "{showDuplicates}").Handler(WithParams(searchCharts))
	apiv1.Methods("GET").Path("/ns/{namespace}/charts/{repo}").Handler(WithParams(listRepoCharts))
	apiv1.Methods("GET").Path("/ns/{namespace}/charts/{repo}/search").Queries("q", "{query}").Handler(WithParams(searchCharts))
	apiv1.Methods("GET").Path("/ns/{namespace}/charts/{repo}/search").Queries("q", "{query}", "showDuplicates", "{showDuplicates}").Handler(WithParams(searchCharts))
