...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppRepoAuthSecret) DeepCopyInto(out *AppRepoAuthSecret) {
	*out = *in
	in.SecretKeyRef.DeepCopyInto(&out.SecretKeyRef)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppRepoAuthSecret.
func (in *AppRepoAuthSecret) DeepCopy() *AppRepoAuthSecret {
	if in == nil {
		return nil
	}
	out := new(AppRepoAuthSecret)
