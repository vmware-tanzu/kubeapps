...
import (
	...
	v1 "github.com/kubeapps/kubeapps/cmd/apprepository-controller/pkg/client/listers/apprepository/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeappsV1().AppRepositories(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubeappsV1().AppRepositories(namespace).Watch(options)
			},
		},
		&apprepository_v1.AppRepository{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *appRepositoryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apprepository_v1.AppRepository{}, f.defaultInformer)
}

func (f *appRepositoryInformer) Lister() v1.AppRepositoryLister {
	return v1.NewAppRepositoryLister(f.Informer().GetIndexer())
}
