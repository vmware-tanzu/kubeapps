...
func setFlags(c *cobra.Command) {
	...
	c.Flags().StringVar(&serveOpts.ConcurrencyPolicy, "failed-jobs-history-limit", "Replace", "	How to treat concurrent executions of a Job. Valid values are: 'Allow', 'Forbid' and 'Replace'")
