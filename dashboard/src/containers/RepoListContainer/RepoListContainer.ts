...
function mapDispatchToProps(dispatch: ThunkDispatch<IStoreState, null, Action>) {
  return {
    ...
    install: async (name: string, url: string, httpProxy: string, authHeader: string, customCA: string) => {
      return dispatch(actions.repos.installRepo(name, url, httpProxy, authHeader, customCA));
    },
