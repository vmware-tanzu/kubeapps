...
export class InstalledPackageDetailCustomDataHelm extends Message<InstalledPackageDetailCustomDataHelm> {
  ...
  static readonly typeName = "kubeappsapis.plugins.helm.packages.v1alpha1.InstalledPackageDetailCustomDataHelm";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 2, name: "release_revision", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): InstalledPackageDetailCustomDataHelm {
    return new InstalledPackageDetailCustomDataHelm().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): InstalledPackageDetailCustomDataHelm {
    return new InstalledPackageDetailCustomDataHelm().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): InstalledPackageDetailCustomDataHelm {
    return new InstalledPackageDetailCustomDataHelm().fromJsonString(jsonString, options);
  }

  static equals(a: InstalledPackageDetailCustomDataHelm | PlainMessage<InstalledPackageDetailCustomDataHelm> | undefined, b: InstalledPackageDetailCustomDataHelm | PlainMessage<InstalledPackageDetailCustomDataHelm> | undefined): boolean {
...
export class RollbackInstalledPackageRequest extends Message<RollbackInstalledPackageRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "kubeappsapis.plugins.helm.packages.v1alpha1.RollbackInstalledPackageRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "installed_package_ref", kind: "message", T: InstalledPackageReference },
    { no: 2, name: "release_revision", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): RollbackInstalledPackageRequest {
    return new RollbackInstalledPackageRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): RollbackInstalledPackageRequest {
    return new RollbackInstalledPackageRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): RollbackInstalledPackageRequest {
    return new RollbackInstalledPackageRequest().fromJsonString(jsonString, options);
  }

  static equals(a: RollbackInstalledPackageRequest | PlainMessage<RollbackInstalledPackageRequest> | undefined, b: RollbackInstalledPackageRequest | PlainMessage<RollbackInstalledPackageRequest> | undefined): boolean {
...
export class RollbackInstalledPackageResponse extends Message<RollbackInstalledPackageResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "kubeappsapis.plugins.helm.packages.v1alpha1.RollbackInstalledPackageResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "installed_package_ref", kind: "message", T: InstalledPackageReference },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): RollbackInstalledPackageResponse {
    return new RollbackInstalledPackageResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): RollbackInstalledPackageResponse {
    return new RollbackInstalledPackageResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): RollbackInstalledPackageResponse {
    return new RollbackInstalledPackageResponse().fromJsonString(jsonString, options);
  }

  static equals(a: RollbackInstalledPackageResponse | PlainMessage<RollbackInstalledPackageResponse> | undefined, b: RollbackInstalledPackageResponse | PlainMessage<RollbackInstalledPackageResponse> | undefined): boolean {
...
export class ImagesPullSecret extends Message<ImagesPullSecret> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "secret_ref", kind: "scalar", T: 9 /* ScalarType.STRING */, oneof: "docker_registry_credential_one_of" },
    { no: 2, name: "credentials", kind: "message", T: DockerCredentials, oneof: "docker_registry_credential_one_of" },
  ]);
  ...
  static equals(a: ImagesPullSecret | PlainMessage<ImagesPullSecret> | undefined, b: ImagesPullSecret | PlainMessage<ImagesPullSecret> | undefined): boolean {
...
export class HelmPackageRepositoryCustomDetail extends Message<HelmPackageRepositoryCustomDetail> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "kubeappsapis.plugins.helm.packages.v1alpha1.HelmPackageRepositoryCustomDetail";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "images_pull_secret", kind: "message", T: ImagesPullSecret },
    { no: 2, name: "oci_repositories", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
    ...
    { no: 6, name: "node_selector", kind: "map", K: 9 /* ScalarType.STRING */, V: {kind: "scalar", T: 9 /* ScalarType.STRING */} },
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): HelmPackageRepositoryCustomDetail {
    return new HelmPackageRepositoryCustomDetail().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): HelmPackageRepositoryCustomDetail {
    return new HelmPackageRepositoryCustomDetail().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): HelmPackageRepositoryCustomDetail {
    return new HelmPackageRepositoryCustomDetail().fromJsonString(jsonString, options);
  }

  static equals(a: HelmPackageRepositoryCustomDetail | PlainMessage<HelmPackageRepositoryCustomDetail> | undefined, b: HelmPackageRepositoryCustomDetail | PlainMessage<HelmPackageRepositoryCustomDetail> | undefined): boolean {
...
export class RepositoryFilterRule extends Message<RepositoryFilterRule> {
  ...
  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): RepositoryFilterRule {
    return new RepositoryFilterRule().fromJsonString(jsonString, options);
  }

  static equals(a: RepositoryFilterRule | PlainMessage<RepositoryFilterRule> | undefined, b: RepositoryFilterRule | PlainMessage<RepositoryFilterRule> | undefined): boolean {
...
export class ProxyOptions extends Message<ProxyOptions> {
  ...
  static equals(a: ProxyOptions | PlainMessage<ProxyOptions> | undefined, b: ProxyOptions | PlainMessage<ProxyOptions> | undefined): boolean {
...
export class PodSecurityContext extends Message<PodSecurityContext> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 4, name: "supplemental_groups", kind: "scalar", T: 3 /* ScalarType.INT64 */, repeated: true },
