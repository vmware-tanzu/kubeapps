          ...
          <span className="tooltip-wrapper">
            ...
            >
              ...
              <a
                target="_blank"
                rel="noreferrer"
                href="https://github.com/vmware-tanzu/kubeapps/blob/site-new/site/content/docs/latest/howto/private-app-repository.md#associating-docker-image-pull-secrets-to-an-apprepository"
              >
                here
              </a>
              .
