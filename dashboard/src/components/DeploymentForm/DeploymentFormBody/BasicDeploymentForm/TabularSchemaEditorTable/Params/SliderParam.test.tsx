...
it.skip("renders a disk size param with a default value", () => {
...
describe("when changing the slide", () => {
  it.skip("changes the value of the string param", () => {
    params.forEach(param => {
      ...
      (slider.prop("onChange") as unknown as (values: number[]) => void)([20]);
  ...
  it.skip("changes the value of the string param without unit", () => {
    params.forEach(param => {
      const cloneParam = { ...param } as IBasicFormParam;
  ...
  it.skip("changes the value of the string param with the step defined", () => {
    params.forEach(param => {
      ...
      const slider = wrapper.find("Slider");
      (slider.prop("onChange") as unknown as (values: number[]) => void)([2]);
...
it.skip("updates state but does not change param value during slider update (only when dropped in a point)", () => {
  params.forEach(param => {
    const handleBasicFormParamChange = jest.fn();
    const wrapper = shallow(
      <SliderParam
...
describe("when changing the value in the input", () => {
  it.skip("parses a number and forwards it", () => {
    params.forEach(param => {
  ...
  it.skip("parses a number and forwards it without unit", () => {
    params.forEach(param => {
      const valueChange = jest.fn();
      const handleBasicFormParamChange = jest.fn(() => valueChange);
      const wrapper = shallow(
  ...
  it.skip("ignores values in the input that are not digits", () => {
    params.forEach(param => {
      const valueChange = jest.fn();
      const handleBasicFormParamChange = jest.fn(() => valueChange);
      const wrapper = shallow(
  ...
  it.skip("modifies the max value of the slider if the input is greater than 100", () => {
    params.forEach(param => {
      const valueChange = jest.fn();
      const handleBasicFormParamChange = jest.fn(() => valueChange);
      const wrapper = shallow(
...
it.skip("uses the param minimum and maximum if defined", () => {
  params.forEach(param => {
...
it.skip("defaults to the min if the value is undefined", () => {
  params.forEach(param => {
    const cloneParam = { ...param } as IBasicFormParam;
