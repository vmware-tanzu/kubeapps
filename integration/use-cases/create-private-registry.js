...
test("Creates a private registry", async () => {
  ...
  // await page.$eval("#root > section > main > div > div > header > div > div > div.clr-col-5 > div > div:nth-child(1) > cds-modal > cds-modal-content > form > cds-form-group > div.docker-creds-subform-button > button", elem => elem.click())
