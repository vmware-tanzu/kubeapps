...
| `frontend.image.tag`                             | NGINX image tag (immutable tags are recommended)                                          | `1.23.1-debian-11-r4` |
...
| `testImage.tag`           | NGINX image tag (immutable tags are recommended)                              | `1.23.1-debian-11-r4` |
