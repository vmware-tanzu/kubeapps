...
| `frontend.image.tag`                             | NGINX image tag (immutable tags are recommended)                                          | `1.23.1-debian-11-r3` |
...
| `authProxy.image.tag`                             | OAuth2 Proxy image tag (immutable tags are recommended)                                  | `7.3.0-debian-11-r21`  |
...
| `testImage.tag`           | NGINX image tag (immutable tags are recommended)                              | `1.23.1-debian-11-r3` |
