...
| `frontend.image.tag`                             | NGINX image tag (immutable tags are recommended)                                          | `1.23.1-debian-11-r5` |
...
| `testImage.tag`           | NGINX image tag (immutable tags are recommended)                              | `1.23.1-debian-11-r5` |
