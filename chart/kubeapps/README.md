...
- If your cluster has a [cert-manager](https://github.com/jetstack/cert-manager) add-on to automate the management and issuance of TLS certificates, configure `ingress.certManager.clusterIssuer` to enable the relevant annotations for cert-manager.
