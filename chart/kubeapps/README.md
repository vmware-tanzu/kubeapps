...
| `frontend.image.tag`                             | NGINX image tag (immutable tags are recommended)                                          | `1.21.5-debian-10-r3` |
...
| `authProxy.image.tag`                             | OAuth2 Proxy image tag (immutable tags are recommended)                       | `7.2.1-debian-10-r8`   |
...
| `testImage.tag`           | NGINX image tag (immutable tags are recommended)                              | `1.21.5-debian-10-r3` |
