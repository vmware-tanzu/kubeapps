...
| `frontend.image.tag`                             | NGINX image tag (immutable tags are recommended)                                          | `1.21.6-debian-11-r9` |
...
| `authProxy.image.tag`                             | OAuth2 Proxy image tag (immutable tags are recommended)                                  | `7.3.0-debian-11-r8`   |
...
| `testImage.tag`           | NGINX image tag (immutable tags are recommended)                              | `1.21.6-debian-11-r9` |
