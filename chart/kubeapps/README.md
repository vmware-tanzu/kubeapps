...
| `frontend.containerSecurityContext.runAsGroup`               | Set NGINX container's Security Context runAsUser                                                      | `10001`                |
| `frontend.containerSecurityContext.runAsNonRoot`             | Set NGINX container's Security Context runAsNonRoot                                                   | `true`                 |
| `frontend.containerSecurityContext.allowPrivilegeEscalation` | Set NGINX container's Security Context runAsNonRoot                                                   | `false`                |
| `frontend.containerSecurityContext.readOnlyRootFilesystem`   | Set NGINX container's Security Context runAsNonRoot                                                   | `true`                 |
...
| `dashboard.containerSecurityContext.runAsGroup`               | Set Dashboard container's Security Context runAsUser                                                      | `10001`              |
| `dashboard.containerSecurityContext.runAsNonRoot`             | Set Dashboard container's Security Context runAsNonRoot                                                   | `true`               |
| `dashboard.containerSecurityContext.allowPrivilegeEscalation` | Set Dashboard container's Security Context runAsNonRoot                                                   | `false`              |
| `dashboard.containerSecurityContext.readOnlyRootFilesystem`   | Set Dashboard container's Security Context runAsNonRoot                                                   | `true`               |
...
| `apprepository.containerSecurityContext.runAsGroup`               | Set AppRepository Controller container's Security Context runAsUser                                                                                                                                      | `10001`                             |
...
| `apprepository.containerSecurityContext.allowPrivilegeEscalation` | Set AppRepository Controller container's Security Context runAsNonRoot                                                                                                                                   | `false`                             |
| `apprepository.containerSecurityContext.readOnlyRootFilesystem`   | Set AppRepository Controller container's Security Context runAsNonRoot                                                                                                                                   | `true`                              |
...
| `authProxy.containerSecurityContext.runAsGroup`               | Set Auth Proxy container's Security Context runAsUser                                                                               | `10001`                |
| `authProxy.containerSecurityContext.runAsNonRoot`             | Set Auth Proxy container's Security Context runAsNonRoot                                                                            | `true`                 |
| `authProxy.containerSecurityContext.allowPrivilegeEscalation` | Set Auth Proxy container's Security Context runAsNonRoot                                                                            | `false`                |
| `authProxy.containerSecurityContext.readOnlyRootFilesystem`   | Set Auth Proxy container's Security Context runAsNonRoot                                                                            | `true`                 |
...
| `pinnipedProxy.containerSecurityContext.runAsGroup`               | Set Pinniped Proxy container's Security Context runAsUser                                                      | `10001`                   |
| `pinnipedProxy.containerSecurityContext.runAsNonRoot`             | Set Pinniped Proxy container's Security Context runAsNonRoot                                                   | `true`                    |
| `pinnipedProxy.containerSecurityContext.allowPrivilegeEscalation` | Set Pinniped Proxy container's Security Context runAsNonRoot                                                   | `false`                   |
| `pinnipedProxy.containerSecurityContext.readOnlyRootFilesystem`   | Set Pinniped Proxy container's Security Context runAsNonRoot                                                   | `true`                    |
...
| `kubeappsapis.containerSecurityContext.runAsGroup`                                              | Set KubeappsAPIs container's Security Context runAsGroup                                                                                                                   | `10001`                            |
| `kubeappsapis.containerSecurityContext.runAsNonRoot`                                            | Set KubeappsAPIs container's Security Context runAsNonRoot                                                                                                                 | `true`                             |
| `kubeappsapis.containerSecurityContext.allowPrivilegeEscalation`                                | Set KubeappsAPIs container's Security Context allowPrivilegeEscalation                                                                                                     | `false`                            |
| `kubeappsapis.containerSecurityContext.readOnlyRootFilesystem`                                  | Set KubeappsAPIs container's Security Context readOnlyRootFilesystem                                                                                                       | `true`                             |
