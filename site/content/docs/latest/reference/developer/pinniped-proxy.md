...
- Missing permissions to access any namespace:
  - Add RBAC config by running `kubectl apply -f ./site/content/docs/latest/reference/manifests/kubeapps-local-dev-users-rbac.yaml`
